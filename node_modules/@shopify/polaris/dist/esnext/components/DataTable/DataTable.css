...
.Polaris-DataTable__Pip_375sr{ height:0.6rem; width:0.6rem; background:var(--p-text-subdued); border-radius:var(--p-border-radius-base); }
...
@media (min-width: 48em){ .Polaris-DataTable__TableRow_1a85o:hover .Polaris-DataTable__Cell_yixs7{ background:var(--p-surface-hovered); } }

.Polaris-DataTable__TableRow_1a85o + .Polaris-DataTable__TableRow_1a85o .Polaris-DataTable__Cell_yixs7{ border-top:0.1rem solid var(--p-divider); }
...
.Polaris-DataTable__Cell--firstColumn_2o4gk{ font-weight:400; color:var(--p-text); text-align:left; white-space:normal; }
...
.Polaris-DataTable__Cell--header_sv8he{ font-weight:400; color:var(--p-text); border-bottom:0.1rem solid var(--p-border); border-top:0; }
...
.Polaris-DataTable__Heading_1brcv:focus:not(:active)::after{ box-shadow:0 0 0 0.2rem var(--p-focused); outline:0.1rem solid transparent; }
...
.Polaris-DataTable__Cell--total_99xdh{ font-weight:600; background:var(--p-surface-subdued); border-bottom:0.1rem solid var(--p-border-subdued); }

.Polaris-DataTable--cellTotalFooter_1fqr9{ border-top:0.1rem solid var(--p-divider); border-bottom:none; border-bottom-left-radius:var(--p-border-radius-base); border-bottom-right-radius:var(--p-border-radius-base); }

.Polaris-DataTable__Footer_z4ij5{ padding:1.6rem; background:var(--p-surface-subdued); color:var(--p-text-subdued); text-align:center; border-top:0.1rem solid var(--p-divider); border-bottom-left-radius:var(--p-border-radius-base); border-bottom-right-radius:var(--p-border-radius-base); }
