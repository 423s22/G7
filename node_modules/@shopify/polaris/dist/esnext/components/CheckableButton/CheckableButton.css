...
.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--plain_vhvci{ border-radius:3px; box-shadow:none; background:transparent; border:none; }

.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--plain_vhvci:hover{ background:transparent; }

.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--selectMode_1hja7{ color:var(--p-text-subdued); font-weight:500; }

.Polaris-CheckableButton_1a7z5.Polaris-CheckableButton__CheckableButton--selected_1xi7t{ color:var(--p-text); }

.Polaris-CheckableButton__Checkbox_1d6zr{ pointer-events:none; height:var(--p-choice-size); width:var(--p-choice-size); margin-left:calc(-0.9rem - var(--p-control-border-width)); }

.Polaris-CheckableButton__Label_2vd36{ flex:1 1; white-space:nowrap; overflow:hidden; max-width:100%; text-overflow:ellipsis; padding:0.1rem 0; margin-left:calc(2rem - var(--p-control-border-width)); }
